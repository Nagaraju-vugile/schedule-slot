...
export default function Scheduler() {
  ...
  const loader = useSelector(state => state?.availabilitiesReducer?.loadingAvailabilities);

  useEffect(() => {
    !schedules&&dispatch(getAvailabilities(selectedStartDate, id, query.get("Type")));
  }, [dispatch]);
