  ...
  return (
    <Container>
          <div className="appointments">
            ...
            {pyStatusMessage==="No Schedules found with in given startDate and endDate range" && <div className="empty-div"></div>}
          ...
          {pyStatusMessage==="No Schedules found with in given startDate and endDate range" && <div className="no-availabilities-div">No schedules found</div>}
          <div className="show-more-div">
            <button className="show-more" onClick={() => size===5?setSize(10):setSize(5)}>OTHER ITEMS</button>
          </div>
    </ Container>
  );
};
