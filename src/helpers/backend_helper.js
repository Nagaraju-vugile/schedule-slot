...
export const bookSlot = (data) => post(`https://bluerosetech01.pegalabs.io/prweb/api/Scheduler/v1/bookslots`, {headers: {'Content-Type': 'application/json',Authorization : `Basic ${base64encodedData}`}}, data);
