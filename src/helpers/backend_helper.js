...
export const getAvailabilities = (formattedDate, formattedNextDate) => get(`https://bluerosetech01.pegalabs.io/prweb/api/v1/data/D_GetSchedules?EmailID=chandanpalamakula@gmail.com&StartDate=${formattedDate}&LimitRange=5`, {headers: {'Content-Type': 'application/json',Authorization : `Basic ${base64encodedData}`}}, formattedDate, formattedNextDate);
